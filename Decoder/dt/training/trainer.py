...
This module provides the base training infrastructure for both
Decision Transformer and Behavior Cloning models. It handles:
...
class Trainer:
    """
    Base trainer class for sequence models.
    
    Provides common functionality for training and evaluation loops.
    Subclasses implement specific training steps (train_step).
    """

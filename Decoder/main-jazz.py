...
def experiment(
    ...
    if dataset=='Cora':
        ...
        dataset_path = f'data/citeseer/output-Citeseer-100traj-{m}-{int(budget * 100)}.pkl'
        with open(dataset_path, 'rb') as f:
            trajectories = pickle.load(f)
    elif dataset=='jazz':
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--dataset', type=str, default='Cora')  # medium, medium-replay, medium-expert, expert
